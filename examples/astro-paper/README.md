...
The example includes responsive navigation, light and dark themes, article
typography, heading links, copy buttons, a reading progress indicator, RSS,
`robots.txt`, and a sitemap. Pagefind and generated Open Graph images are
intentionally omitted.

Install esbuild as `esbuild`, then run:
