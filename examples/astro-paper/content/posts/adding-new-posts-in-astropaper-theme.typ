...
#show: post.with(
  ...
  description: "Practical conventions for creating and organizing posts in an AstroPaper site.",
  author: "Sat Naing",
...
An AstroPaper post combines a small metadata record with a document body. Keep
