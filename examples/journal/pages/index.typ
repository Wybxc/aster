...
#html.main(id: "main-content")[
  #html.header[
    ...
    #html.p[
      ...
      sensible SEO defaults, and built-in light and dark modes.
    ]
    #html.p[
      Browse the articles or inspect the
      #link("https://github.com/Wybxc/aster")[Aster source]
      to see how the project is assembled.
    ]
    #html.aside[
