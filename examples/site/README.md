...
source templates. The `generate/atom.xml.typ` generator uses the Universe `exemel`
package to publish an Atom feed from the journal collection; feed policy remains
